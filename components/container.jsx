    ...
    return(
      <div>
        ...
        <div className={'row flexCenter'}>
          <button className={'btn-square'} onClick={this.setSquare.bind(this)}>Square</button>
          <button className={'btn-diamond'} onClick={this.setDiamond.bind(this)}>Diamond</button>
